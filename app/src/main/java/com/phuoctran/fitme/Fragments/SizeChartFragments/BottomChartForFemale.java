...
public class BottomChartForFemale extends Fragment {
    ListView lstView;
    ...
    class ChartAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = ((LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.layout_chart_item, null);
            ...
            TextView col6 = (TextView) convertView.findViewById(R.id.txtCol6);
            ...
            col4.setText(((ChartDetail) this.lst.get(position)).EU);
            col5.setText(((ChartDetail) this.lst.get(position)).KR);
            col6.setText(((ChartDetail) this.lst.get(position)).JP);
            return convertView;
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_chart_list_bottom_female, container, false);
    }

    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        this.lstView = (ListView) getActivity().findViewById(R.id.listView_chart_bottom_female);
        this.lstView.setAdapter(new ChartAdapter(getActivity(), ChartConstants.lstBottomsFemale));
    }
}
