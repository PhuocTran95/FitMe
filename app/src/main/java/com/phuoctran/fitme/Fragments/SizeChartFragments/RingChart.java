...
public class RingChart extends Fragment {
    ListView lstView;
    ...
    class ChartAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ((TextView) convertView.findViewById(R.id.txtCol1)).setText(((ChartDetail) this.lst.get(position)).US);
            col2.setText(((ChartDetail) this.lst.get(position)).EU);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_chart_list_ring, container, false);
    }

    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        this.lstView = (ListView) getActivity().findViewById(R.id.listView_chart_ring);
        this.lstView.setAdapter(new ChartAdapter(getActivity(), ChartConstants.lstRing));
    }
}
