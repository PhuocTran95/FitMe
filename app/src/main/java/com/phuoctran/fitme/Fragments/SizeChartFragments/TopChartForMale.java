...
public class TopChartForMale extends Fragment {
    ListView lstView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_chart_list_top_male, container, false);
    }

    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        this.lstView = (ListView) getActivity().findViewById(R.id.listView_chart_top_male);
        this.lstView.setAdapter(new ChartAdapter(getActivity(), ChartConstants.lstTopsMale));
    }
}
